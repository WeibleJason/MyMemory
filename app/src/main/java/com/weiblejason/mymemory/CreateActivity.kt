...
import com.weiblejason.mymemory.utils.*
import java.io.ByteArrayOutputStream

class CreateActivity : AppCompatActivity() {

    companion object {
        private const val PICK_PHOTO_CODE = 432
    ...
    private fun saveDataToFirebase(function: () -> Unit) {
        ...
        db.collection("games").document(gameName)
            ...
            .addOnCompleteListener { gameCreationTask ->
                ...
                if (!gameCreationTask.isSuccessful) {
                    Log.e(TAG, "Exception with gaem creation", gameCreationTask.exception)
    ...
    private fun getImageByteArray(photoUri: Uri): ByteArray {
        ...
        val height = 250
        val factor = height / originalBitmap.height.toFloat()
        val scaledBitmap = Bitmap.createScaledBitmap(originalBitmap, (originalBitmap.width * factor).toInt(), height, true)
